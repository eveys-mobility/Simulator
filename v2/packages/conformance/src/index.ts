 ...
 *  profile's cases is a one-import change. Negatives are tagged
 *  with their target profile so the SPA still groups them into the
 *  same profile section as the positive cases. */
